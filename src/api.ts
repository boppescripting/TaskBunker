...
export const createBoard = (title: string, color: string) =>
...
export const updateColumn = (boardId: number, colId: number, data: Partial<{ title: string; card_ids: number[] }>) =>
...
// Cards
export const getCards = (boardId: number) => api.get(`/boards/${boardId}/cards`)
